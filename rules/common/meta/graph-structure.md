...
- **Routes to**: `backend/index.mdc`, `frontend/index.mdc`, `mobile/index.mdc`, `generic/index.mdc`, `tools/index.mdc`, `technologies/index.mdc`
- **Methodology intents** (service breakdown, migrate, refactor, trace pipeline, upgrade scala) route directly to skills — no category index

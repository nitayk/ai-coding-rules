...
- Refactoring logic (separate task; handle structural refactoring on its own)
...
- Functions with zero callers (use grep or code search; a code-graph tool if available)

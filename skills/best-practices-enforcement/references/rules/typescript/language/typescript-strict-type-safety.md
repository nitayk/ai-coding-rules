...
- [Generic Error Handling](../../../generic/error-handling/universal-patterns.md) - Universal error handling patterns
- [API Defensive Programming](api-defensive-programming.md) - Safe property access, schema resilience

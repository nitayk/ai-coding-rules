...
## Use Typed Class Constants (PHP 8.3+)

**Declare types for class constants** to enforce consistency across implementations.

```php
// Good: Typed constant (PHP 8.3+)
interface Config
{
...
{
    public const string VERSION = '1.0';  // Must be string
}

// Bad: Untyped - implementing class could use wrong type
interface Config
{
...
## Use #[Override] for Overridden Methods (PHP 8.3+)

**Mark overridden methods** to catch typos and signature mismatches at compile time.

```php
// Good: #[Override] attribute (PHP 8.3+)
...
// Bad: Typo in method name - silently creates new method
class AdminUser extends User
{
    public function getRolle(): string  // Typo! No override.
    {
        return 'admin';
    }
}
...
**PHP-Specific:**
- [Style Guide](style-guide.md) - PSR-1, PSR-12, PSR-4
- [PHP Testing Patterns](../testing/php-testing-patterns.md) - PHPUnit, mocking, AAA
- [PHP Security Patterns](../meta/php-security-patterns.md) - SQL injection, XSS, CSRF
- [PHP Production Patterns](../meta/php-production-patterns.md) - OPcache, Composer, error handling

...
**If a security issue is found during development or review:**
1. **STOP immediately** - Do not proceed with feature implementation.
2. Use **security-auditor** agent or equivalent tools to analyze the scope.
3. Fix CRITICAL issues before continuing with any other work.
4. Rotate any secrets that may have been exposed.
5. Review the entire codebase for similar vulnerability patterns.

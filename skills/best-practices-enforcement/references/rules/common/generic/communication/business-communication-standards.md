...
- If the value is **"vendor_x"**, we show it as **"brand_x"** (our normalized name).
- Otherwise, we keep the value as provided.
- If the value is unrecognized or missing, we display **"unknown"** (we don't use nulls in our analytics store).

...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal SOLID principles (Interface Segregation Principle)

**Go-Specific:**
- [Idiomatic Error Handling](idiomatic-error-handling.md) - Error handling patterns
- [Error Handling Patterns](error-handling-patterns.md) - Basic error handling

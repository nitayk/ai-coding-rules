...
Pragmatic project layout patterns. Influenced by — but **not** binding to —
[golang-standards/project-layout](https://github.com/golang-standards/project-layout),
which self-declares non-official ("It's not an official standard defined by
the core Go dev team"). For meta-level guidance on when to *not* adopt the
full template, see [Project Layout Pragmatism](../meta/project-layout-pragmatism.md).

The toolchain-enforced rules (`internal/` blocks external imports, `cmd/<name>`
is `package main`, `testdata/` is ignored by `go build`) are load-bearing; the
rest below is convention. Start small; add directories when you feel pain.
...
- [Generic Architecture Principles](../../../../generic/architecture/core-principles.md) - Universal architecture principles (interface-centric design, SRP, dependency injection, separation of concerns)
...
- [Standard Go Project Layout](https://github.com/golang-standards/project-layout) — community pattern, **self-declares non-official**; treat as inspiration, not a standard.
- [Google Go Style Decisions](https://google.github.io/styleguide/go/decisions) — canonical for package naming and layout decisions.

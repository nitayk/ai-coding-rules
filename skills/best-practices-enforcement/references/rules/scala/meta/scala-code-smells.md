...
- [Generic Code Quality Principles](../../../generic/code-quality/core-principles.md) - Universal code smells (God Object, Feature Envy, Data Clumps, etc.) and SOLID/DRY/KISS/YAGNI principles
...
- [Scala Code Style Guide](scala-code-style.md)
- [Compiler-Friendly Types](../language/compiler-friendly-types.md) - Comprehensive guide on avoiding casts and other compiler lies
...
See [Scala Code Style Guide](scala-code-style.md) and [Compiler-Friendly Types](../language/compiler-friendly-types.md) for patterns like:

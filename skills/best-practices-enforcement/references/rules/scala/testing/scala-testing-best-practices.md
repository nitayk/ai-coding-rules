...
- **Write unit tests for component isolation**: Test individual components in isolation using mocks or stubs for external dependencies.  
  ...
  **Note**: For new code, prefer **[Pure Testing Patterns](pure-testing-patterns.md)** - use functional dependencies instead of mocks for cleaner, more maintainable tests.
...
**Scala-Specific:**
- **[Correctness First](../meta/correctness-first.md)** - **Make it correct first, then optimize** - Use property-based testing to verify correctness before optimizing
- **[Pure Testing Patterns](pure-testing-patterns.md)** - **Making tests side-effect-free, declarative, and composable** - Replace mocks with functional dependencies, use parametric tests, compose with monoids

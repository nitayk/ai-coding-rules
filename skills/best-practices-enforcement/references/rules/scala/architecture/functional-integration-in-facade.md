...
### Resilience Patterns
```scala
// Good: Circuit breaker integration (Akka shown; for new code, use Apache Pekko —
// `import org.apache.pekko.pattern.CircuitBreaker` — see ../performance/akka-to-pekko-migration.md)
...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal principles (pure functions, functional core/imperative shell)

**Scala-Specific:**
- [Error Handling Patterns](../language/error-handling-patterns.md) - For comprehensive error handling strategies
- [Core Structural Guidelines](core-structural-guidelines.md) - Foundation architecture guidelines

---

## References
- [Core Structural Guidelines](../architecture/core-structural-guidelines.md) - For architectural patterns
- [Performance Conscious FP](../performance/performance-conscious-fp.md) - For performance optimization in facades

...
```scala
// Good: Use Either for fail-fast validation (sequential, stops at first error)
...
// Good: Use Validated for error accumulation (collect all errors)
...
- [Generic Error Handling Principles](../../../../generic/error-handling/universal-patterns.md) - Universal error handling patterns (fail fast, explicit errors, input validation)
...
- [Make Illegal States Unrepresentable](make-illegal-states-unrepresentable.md) - Using sealed traits for validation
...
- [Compiler-Friendly Types](compiler-friendly-types.md) - **Core principles: Stop lying to the compiler** - comprehensive guide on null, exceptions, casts, typed wrappers
- [Avoid Option Blindness](avoid-option-blindness.md) - **Use domain-specific types for validation errors** - Don't use Option when absence has meaning
- [Error Handling Patterns](error-handling-patterns.md) - For basic error handling patterns with Option, Either, and Try
- [Performance Conscious FP](../performance/performance-conscious-fp.md) - For performance considerations when validating in hot paths
- [Implicit Extension Methods](implicit-extension-methods.md) - For safe extension methods and parsing utilities
- [Functional Integration Patterns](../architecture/functional-integration-in-facade.md) - For validation in facade architectures

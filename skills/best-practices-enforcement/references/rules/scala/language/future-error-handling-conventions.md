...
- [Generic Error Handling Principles](../../../../generic/error-handling/universal-patterns.md) - Universal error handling patterns (explicit error types, distinguish expected vs unexpected errors)

**Scala-Specific:**
- [Error Handling Patterns](error-handling-patterns.md) - Foundation for error handling with Option, Either, Try
- [Scala Efficient Future Management](../performance/scala-efficient-future-management.md) - Performance patterns for Future

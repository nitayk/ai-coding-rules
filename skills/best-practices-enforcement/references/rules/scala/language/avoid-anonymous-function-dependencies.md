...
class DoFinanceStuffSpec extends AnyFlatSpec with Matchers {
  ...
  // Good: Also fine: Lambda for simple test cases
...
trait PaymentProcessor {
  ...
  // Good: Can add new methods without breaking existing code
...
```scala
// NOTE: Better but still not ideal
...
```scala
// Good: Fine: Anonymous implementation in test
val service = new Service(
  new Processor {
...
- [Generic Architecture Principles](../../../../generic/architecture/core-principles.md) - Universal architecture principles (interface-centric design, dependency injection)

**Scala-Specific:**
- [Pure Testing Patterns](../testing/pure-testing-patterns.md) - Using functional dependencies in tests
- [Compiler-Friendly Types](compiler-friendly-types.md) - Type safety principles
- [Avoid Overloading](avoid-overloading.md) - Prefer explicit naming

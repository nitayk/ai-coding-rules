...
- **Use Option for potentially missing values**, never null:  
  ...
  **Note**: Avoid "Option blindness" - when `None` could mean different things, use domain-specific types instead. See [Avoid Option Blindness](avoid-option-blindness.md) for details.
...
- **Kibana-friendly error patterns**:
  ...
  ```scala
  // Good: Example: Clean separation of static message and variable tags
  LoggingUtil.logErrorAndThrowGeneralException(
...
- [Generic Error Handling Principles](../../../../generic/error-handling/universal-patterns.md) - Universal error handling patterns (fail fast, explicit errors, proper propagation)

**Scala-Specific:**
- [Future Error Handling Conventions](future-error-handling-conventions.md) - **Adopt explicit error handling conventions for Future** - Distinguish business errors from defects, use Future[Either[E, A]] or EitherT

...
- **Use function lifting for Option/Either operations** (context-aware):  
  ...
  // Good: Standard library approach (no external dependencies)
...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal principles (pure functions, functional composition, DRY)

**Scala-Specific:**
- [Lazy Evaluation and Productivity](lazy-evaluation-and-productivity.md) - Composing lazy operations for infinite sequences
- [Performance Conscious FP](../performance/performance-conscious-fp.md) - Performance considerations for function composition
- [Referential Transparency](referential-transparency.md) - Pure functions and composition

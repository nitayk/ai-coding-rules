...
### Positive: The Truth: Use Sealed Types
```scala
...
### Positive: The Truth: Functional Core, Imperative Shell
```scala
...
**See [Make Illegal States Unrepresentable](make-illegal-states-unrepresentable.md) for comprehensive guidance** - This is especially important for AI-assisted development, as AI agents work locally and can't enforce global invariants unless encoded in types.
...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal principles (make illegal states unrepresentable, pure functions, type safety, avoid type casts)

**Scala-Specific:**
- [Make Illegal States Unrepresentable](make-illegal-states-unrepresentable.md) - **Comprehensive guide on using sealed traits to prevent invalid combinations** - Especially important for AI-assisted development
- [Avoid Overloading](avoid-overloading.md) - Prefer explicit naming over method overloading
- [Avoid Anonymous Function Dependencies](avoid-anonymous-function-dependencies.md) - Use named traits instead of function types for dependencies
- [Avoid Option Blindness](avoid-option-blindness.md) - Use domain-specific types when absence has meaning
- [Prefer Case Classes Over Tuples](prefer-case-classes-over-tuples.md) - Use case classes for structured data - better type safety and discoverability
- [Error Handling Patterns](error-handling-patterns.md) - Option, Either, Try patterns
- [Validation and Safe Operations](validation-and-safe-operations.md) - Validation patterns
- [Referential Transparency](referential-transparency.md) - Pure functions
- [Pattern Matching Best Practices](pattern-matching-best-practices.md) - Exhaustive matching
- [Scala Complex Enum Best Practices](../data/scala-complex-enum-best-practices.md) - Sealed types
- [Code Smells](../meta/scala-code-smells.md) - Identifying anti-patterns

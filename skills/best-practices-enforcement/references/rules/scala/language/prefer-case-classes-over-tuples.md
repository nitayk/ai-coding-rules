...
```scala
// Good: Advanced: Using named tuples with Selectable for automatic derivation
...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal principles (primitive obsession code smell, use domain objects)

**Scala-Specific:**
- [Compiler-Friendly Types](compiler-friendly-types.md) - Type safety principles, typed wrappers
- [Avoid Overloading](avoid-overloading.md) - Prefer explicit naming
- [Pattern Matching Best Practices](pattern-matching-best-practices.md) - Pattern matching on case classes

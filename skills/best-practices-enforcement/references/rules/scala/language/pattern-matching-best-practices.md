...
import com.example.matching.PatternMatchingUtils._
...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal principles (make illegal states unrepresentable, exhaustive pattern matching)

**Scala-Specific:**
- [Prefer Case Classes Over Tuples](prefer-case-classes-over-tuples.md) - Use case classes instead of tuples for pattern matching

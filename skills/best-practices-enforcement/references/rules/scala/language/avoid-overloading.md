...
// Bad: Problem: Type inference can pick wrong overload
val value: Any = "123"
processor.process(value)  // Compile error - ambiguous!

// Bad: Problem: Small type change picks different overload
...
// Bad: Problem: Can't refer to method as value
...
// Bad: Problem: Adding implicit changes which overload is called!
...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal principles (explicit over implicit, meaningful names)

**Scala-Specific:**
- [Compiler-Friendly Types](compiler-friendly-types.md) - Type safety principles
- [Implicit Extension Methods](implicit-extension-methods.md) - Type classes and implicits
- [Pattern Matching Best Practices](pattern-matching-best-practices.md) - Sealed traits and union types
- [Functional Composition and HOF](functional-composition-and-hof.md) - Higher-order functions

...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal principles (make illegal states unrepresentable, explicit error types)

**Scala-Specific:**
- [Error Handling Patterns](error-handling-patterns.md) - Option, Either, Try patterns
- [Validation and Safe Operations](validation-and-safe-operations.md) - Validation with explicit errors
- [Compiler-Friendly Types](compiler-friendly-types.md) - Type safety principles
- [Pattern Matching Best Practices](pattern-matching-best-practices.md) - Exhaustive matching on sealed types

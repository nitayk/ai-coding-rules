...
**Scala-Specific:**
- [Compiler-Friendly Types](compiler-friendly-types.md) - Comprehensive guide on separating pure functions from side-effects, avoiding null, exceptions, and casts
- [Iterator Safety](iterator-safety.md) - Iterators break referential transparency (stateful and mutable)
- [Lazy Evaluation and Productivity](lazy-evaluation-and-productivity.md) - Lazy evaluation and working with infinite sequences
- [Error Handling Patterns](error-handling-patterns.md) - Using Option, Either, Try for explicit error handling

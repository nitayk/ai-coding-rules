...
private[myapp] def maybeApplyTimestampFiltering(
...
## Package-Private Testing Patterns
...
object PatternMatchingUtils {
  ...
  // Good: DECISION: Package-private (not private)
  ...
  // Bad: MISTAKE: Making it public when only used for testing
...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal principles (encapsulation, information hiding)

...
## Periodic GC for Memory-Heavy Loops

**For loops creating many temporary objects, consider periodic garbage collection:**

```python
# Good: Periodic cleanup in memory-heavy loops
def process_with_cleanup(items: list[dict], batch_size: int = 1000):
    results = []
...
**Python-Specific:**
- [Async Patterns](../language/async-patterns.md) - Async performance
- [Pythonic Patterns](../language/pythonic-patterns.md) - General Python patterns

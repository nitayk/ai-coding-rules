...
- [Generic Code Quality Principles](../../../../generic/code-quality/core-principles.md) - Universal principles (type safety, make illegal states unrepresentable)

**Python-Specific:**
- [Type Annotations Everywhere](type-annotations-everywhere.md) - Comprehensive type annotation guide
- [Pythonic Patterns](pythonic-patterns.md) - General Python best practices

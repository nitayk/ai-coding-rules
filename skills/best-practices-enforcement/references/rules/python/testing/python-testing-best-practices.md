...
## CRITICAL: The #1 Testing Anti-Pattern - Testing Structure, Not Behavior

**This bug pattern cost us hours of debugging!**

```python
# ❌ BAD: Tests dataclass creation, NOT the logic that populates it
def test_method_info_creation():
    method = MethodInfo(
        name="myMethod",
        is_compiler_generated=False,  # ← HARDCODED! Parser never tested!
    )
...
```python
# ✅ GOOD: Tests the LOGIC that determines if a method is compiler-generated
...
```python
# ✅ GOOD: Tests specific logic condition
...
```python
# ✅ GOOD: Tests parser + processor working together
...
```python
# ✅ GOOD: Tests the feature/behavior users expect
...
# ✅ GOOD: Comprehensive coverage of all cases
...
# ❌ BAD: Vague names that don't explain what's tested
...
```python
# ❌ BAD: Wrong SemanticDB kind value
case_class.kind = 5  # WRONG! CLASS is 13, not 5

# ✅ GOOD: Correct constants (or use named constants!)
CLASS_KIND = 13
TRAIT_KIND = 14
METHOD_KIND = 3
...
# ✅ GOOD: Tests edge cases that caused bugs
...
- [Generic Testing Principles](../../../../generic/testing/core-principles.md) - Universal testing principles (test behavior not implementation, AAA pattern, isolation)
...
- **[Scala Testing Best Practices](../../scala/testing/scala-testing-best-practices.md)** - Similar patterns for Scala

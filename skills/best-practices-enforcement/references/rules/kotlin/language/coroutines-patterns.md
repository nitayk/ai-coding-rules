...
- [Android Best Practices](../android/android-best-practices.md) - Android-specific coroutine patterns
- [Style Guide](style-guide.md) - Kotlin style conventions
- [supervisorScope vs coroutineScope decision rule](supervisor-vs-coroutine-scope.md) - When to isolate sibling failures
- [No GlobalScope, inject dispatcher](no-global-scope-inject-dispatcher.md) - Lifecycle and testability mandate

---

## References

- [Coroutines overview (kotlinlang.org)](https://kotlinlang.org/docs/coroutines-overview.html) — Canonical entry to suspend/Job/Dispatcher/Flow (2025-08-26)
